...
<div class="icon">
				...
				<a href="" class="env"><i class="far fa-envelope" aria-hidden="true"></i><?php the_field('tags1','option'); ?></i></a>
				<a href="" class="phn"><i class="fas fa-phone-volume"></i><?php the_field('tags2','option'); ?></a>
	<ul class="icons">
...
<div class="footer-copy"><?php the_field('text4','option'); ?></div>
<?php wp_footer();  ?>
