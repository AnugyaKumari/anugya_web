...
<head>
    ...
    <link rel="stylesheet" is="style.css" href="<?php echo get_template_directory_uri(); ?>/style.css" type="text/css" media="all">
...
<div class="container cont">
	<div class="firstlogo">
		...
		<a href="" class="envs"><i class="far fa-envelope" aria-hidden="true"></i><?php the_field('tags1','option'); ?></i></a>
        <a href="" class="phns"><i class="fas fa-phone-volume"></i><?php the_field('tags2','option'); ?></a>
	<ul class="icons">
                ...
                <li><a class="ss" href="<?php echo $media['media_icon3'];?>"><i class="fab fa-linkedin-in a"></i></a></li>
            </ul>
			</div>	
<!----Nav Menu--------->
